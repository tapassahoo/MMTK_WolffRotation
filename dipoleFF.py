...
class dipoleForceField(ForceField):
    ...
    """Dipole-dipole potential with respect to two molecules in space
    ...
    def __init__(self, atom1, atom2, atom3, atom4):
        ...
        self.atom_index1, self.atom_index2, self.atom_index3, self.atom_index4 = self.getAtomParameterIndices((atom1,atom2, atom3, atom4))

        # Store arguments that recreate the force field from a pickled
        # universe or from a trajectory.
        self.arguments = (self.atom_index1, self.atom_index2, self.atom_index3, self.atom_index4)
...
#                                       self.atom1,self.atom2)]
        ...
        f, offsets = self.beadOffsetsAndFactor([self.atom_index1, self.atom_index2, self.atom_index3, self.atom_index4], global_data)
        return [dipoleTerm(universe._spec,
                            self.atom_index1 + o1,
                            self.atom_index2 + o2,
                            self.atom_index3 + o3,
                            self.atom_index4 + o4) for o1,o2,o3,o4 in offsets]
